...
const TEKSTER = {
    ...
    en: {
        ...
        bodyText1:
            'On March 20th, changes were introduced for you who are registered as a job seeker with Nav. Every 14 days you will receive a task on My Page where you confirm that you will still be registered as a job seeker. The deadlines will be the same as today.',
        bodyText2:
