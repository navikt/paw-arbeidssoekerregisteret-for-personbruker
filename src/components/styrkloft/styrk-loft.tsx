...
import AktivBruker from '@/components/styrkloft/aktiv-bruker';
import Avmeldt from '@/components/styrkloft/avmeldt';
import { KvitteringAvmeldt } from '@/components/styrkloft/kvittering-avmeldt';
import type { StyrkAction, StyrkState } from '@/components/styrkloft/reducer';
import StartStyrkloft from '@/components/styrkloft/start-styrkloft';
